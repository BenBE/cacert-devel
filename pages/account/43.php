...
?>
  ...
  <tr>
    ...
    <td class="DataTD"><a href="account.php?id=43&amp;assurer_blocked=<?=intval($row['id'])?>&amp;csrf=<?=make_csrf('admassblock')?>"><?=$row['assurer_blocked']?></a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="DataTD"><a href="account.php?id=43&amp;ttpadmin=<?=$row['id']?>&amp;csrf=<?=make_csrf('admttpadmin')?>"><?=$row['ttpadmin']?></a> (0 = none, 1 = TTP admin, 2 = TTP TOPUP dmin)</td>
  </tr>
  <tr>
    <td class="DataTD"><?=_("Location Admin")?>:</td>
    <td class="DataTD"><a href="account.php?id=43&amp;locadmin=<?=$row['id']?>&amp;csrf=<?=make_csrf('admlocadmin')?>"><?=$row['locadmin']?></a></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="DataTD"><a href="account.php?id=43&amp;adadmin=<?=$row['id']?>"><?=$row['adadmin']?>&amp;csrf=<?=make_csrf('admadadmin')?></a> (0 = none, 1 = submit, 2 = approve)</td>
  </tr>
<!--  <tr>
    <td class="DataTD"><?=_("Tverify Account")?>:</td>
    <td class="DataTD"><a href="account.php?id=43&amp;tverify=<?=$row['id']?>"><?=$row['tverify']?>&amp;csrf=<?=make_csrf('admtverify')?></a></td>
  </tr> -->
  <tr>
